...
static int nNumber = LIDAR_BUFF_LEN;
static double x_sin[LIDAR_BUFF_LEN];
static double y_cos[LIDAR_BUFF_LEN];
static int pnt_x[LIDAR_BUFF_LEN];
static int pnt_y[LIDAR_BUFF_LEN];
